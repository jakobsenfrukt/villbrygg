          ...
          S.list()
            ...
            .items([
              ...
              S.listItem()
                ...
                .schemaType("product")
                .icon(MdLiquor)
                .child(S.documentTypeList("product").title("Product list")),
              S.listItem()
                .title("Categories")
              ...
              S.listItem()
                ...
                .child(
                  S.documentList()
                    ...
                    .menuItems(
                      S.documentTypeList("shopsCountry").getMenuItems()
                    )
                    .child((id) =>
                      S.documentList()
                        .id("onlineShop")
                        .title("Online Shops")
                        .filter(
                          '_type == "onlineShop" && $id in countries[]._ref'
                        )
                        .params({ id })
                        .defaultOrdering([{ field: "name", direction: "asc" }])
                        .menuItems(
                          S.documentTypeList("onlineShop").getMenuItems()
                        )
                    )
                ),
              S.listItem()
                  ...
                  S.documentList()
                    ...
                    .child((id) =>
                      S.documentList()
                        ...
                        .defaultOrdering([{ field: "name", direction: "asc" }])
                        .menuItems(
                          S.documentTypeList("location").getMenuItems()
                        )
                    )
                ),
              S.listItem()
                  ...
                  S.documentList()
                    ...
                    .child((id) =>
                      S.documentList()
                        ...
                        .menuItems(
                          S.documentTypeList("shopsCity").getMenuItems()
                        )
                    )
                ),
              S.listItem()
              ...
              S.listItem()
                ...
                .child(
                  S.documentList()
                    ...
                    .menuItems(
                      S.documentTypeList("shopsCategory").getMenuItems()
                    )
                ),
            ])
        ),
              ...
              S.listItem()
                ...
                .child(
                  S.documentList()
                    ...
                    .filter(
                      '_type == "article" && (!defined(locale) || locale == "no")'
                    )
              ...
              S.listItem()
                ...
                .child(
                  S.documentList()
                    ...
                    .filter(
                      '_type == "article" && (!defined(locale) || locale == "en")'
                    )
                    .defaultOrdering([{ field: "title", direction: "asc" }])
                    .menuItems(S.documentTypeList("article").getMenuItems())
                ),
